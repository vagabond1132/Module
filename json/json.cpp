...

Value::Value(): mValueType(NULLVal), mIntVal(0), mFloatVal(0), mDoubleVal(0), mBoolVal(false)
 {
 }

Value::Value(int v): mValueType(IntVal), mIntVal(v), mFloatVal((float)v), mDoubleVal((double)v)
 {
 }
...
Value::Value(const std::string& v)	: mValueType(StringVal), mStringVal(v)
{
}

Value::Value(const char* v): mValueType(StringVal), mStringVal(v)
{
}

Value::Value(const Object& v): mValueType(ObjectVal), mObjectVal(v)
{
}

Value::Value(const Array& v): mValueType(ArrayVal), mArrayVal(v)
{
}

Value::Value(const bool v)	: mValueType(BoolVal), mBoolVal(v)
{
}
